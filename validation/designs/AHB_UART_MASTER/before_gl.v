...
module AHB_UART_MASTER(HCLK, HRESETn, HADDR, HTRANS, HSIZE, HWRITE, HWDATA, HREADY, HRDATA, RX, TX);
  ...
  sky130_fd_sc_hd__nor3b_1 _251_ (
    .A(state[1]),
    .B(state[3]),
    .C_N(state[2]),
    .Y(_138_)
  ...
  sky130_fd_sc_hd__nor4bb_1 _259_ (
    .A(state[0]),
    .B(state[3]),
    .C_N(state[2]),
    .D_N(state[1]),
  ...
  sky130_fd_sc_hd__a211oi_1 _275_ (
    .A1(tx_done),
    .A2(_109_),
    .B1(_149_),
    .C1(_159_),
  ...
  sky130_fd_sc_hd__a211oi_1 _282_ (
    .A1(tx_done),
    .A2(_111_),
    .B1(_164_),
    .C1(_165_),
  ...
  BAUDGEN uBAUDGEN (
    ...
    .clk(HCLK),
    .en(_189_),
    .prescale({ _205_, _204_, _203_, _202_, _201_, _200_, _199_, _198_, _197_, _196_, _193_, _192_, _195_, _194_, _191_, _190_ }),
    .rst_n(HRESETn)
  );
  UART_RX uUART_RX (
    .b_tick(b_tick),
