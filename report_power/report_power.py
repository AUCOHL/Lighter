...
##############################
    ...
    all_cells_normal_before = parse_all_cells_power_report(
        "./stats/all_cells_normal_before.txt"
    )
    all_cells_normal_after = parse_all_cells_power_report(
        "./stats/all_cells_normal_after.txt"
    )
    ...
    ff_cells_normal_before = parse_cell_collection_power_report(
        "./stats/ff_cells_normal_before.txt"
    )
    ff_cells_high_before = parse_cell_collection_power_report(
        "./stats/ff_cells_high_before.txt"
    )
    ...
    power_before_clock_gating.append(
        all_cells_normal_before[0] - ff_cells_normal_before[0] + ff_cells_high_before[0]
    )
    power_before_clock_gating.append(
        all_cells_normal_before[1] - ff_cells_normal_before[1] + ff_cells_high_before[1]
    )
    power_before_clock_gating.append(
        all_cells_normal_before[2] - ff_cells_normal_before[2] + ff_cells_high_before[2]
    )
    power_before_clock_gating.append(
        all_cells_normal_before[3] - ff_cells_normal_before[3] + ff_cells_high_before[3]
    )
    ...
    all_cg_and_ff_normal_after = parse_cell_collection_power_report(
        "./stats/all_cg_and_ff_normal_after.txt"
    )

    # get  clock_gates_normal
    clock_gates_normal = parse_cell_collection_power_report(
        "./stats/clock_gates_normal.txt"
    )

    # claculate clockgated_ff_cells_normal = all_cg_and_ff_normal_after - clock_gates_normal
    clockgated_ff_cells_normal = list()
    clockgated_ff_cells_normal.append(
        all_cg_and_ff_normal_after[0] - clock_gates_normal[0]
    )
    clockgated_ff_cells_normal.append(
        all_cg_and_ff_normal_after[1] - clock_gates_normal[1]
    )
    clockgated_ff_cells_normal.append(
        all_cg_and_ff_normal_after[2] - clock_gates_normal[2]
    )
    clockgated_ff_cells_normal.append(
        all_cg_and_ff_normal_after[3] - clock_gates_normal[3]
    )
    ...
    all_cg_and_ff_low_after = parse_cell_collection_power_report(
        "./stats/all_cg_and_ff_low_after.txt"
    )
    ...
    all_cg_and_ff_high_after = parse_cell_collection_power_report(
        "./stats/all_cg_and_ff_high_after.txt"
    )

    # get  clock_gates_high
    clock_gates_high = parse_cell_collection_power_report(
        "./stats/clock_gates_high.txt"
    )
    ...
    all_flipflops_normal_after = parse_cell_collection_power_report(
        "./stats/all_flipflops_normal_after.txt"
    )
    ...
    not_gated_flipflops_normal.append(
        all_flipflops_normal_after[0] - clockgated_ff_cells_normal[0]
    )
    not_gated_flipflops_normal.append(
        all_flipflops_normal_after[1] - clockgated_ff_cells_normal[1]
    )
    not_gated_flipflops_normal.append(
        all_flipflops_normal_after[2] - clockgated_ff_cells_normal[2]
    )
    not_gated_flipflops_normal.append(
        all_flipflops_normal_after[3] - clockgated_ff_cells_normal[3]
    )
    ####################################################################################################
    ...
    all_flipflops_high_after = parse_cell_collection_power_report(
        "./stats/all_flipflops_high_after.txt"
    )

    # claculate not_gated_flipflops_high = all_flipflops_high_after - clockgated_ff_cells_high
    not_gated_flipflops_high = list()
    not_gated_flipflops_high.append(
        all_flipflops_high_after[0] - clockgated_ff_cells_high[0]
    )
    not_gated_flipflops_high.append(
        all_flipflops_high_after[1] - clockgated_ff_cells_high[1]
    )
    not_gated_flipflops_high.append(
        all_flipflops_high_after[2] - clockgated_ff_cells_high[2]
    )
    not_gated_flipflops_high.append(
        all_flipflops_high_after[3] - clockgated_ff_cells_high[3]
    )
    ####################################################################################################
    ...
    power_after_clock_gating.append(
        all_cells_normal_after[0]
        - clockgated_ff_cells_normal[0]
        + clockgated_ff_cells_low[0]
        - clock_gates_normal[0]
        + clock_gates_high[0]
        - not_gated_flipflops_normal[0]
        + not_gated_flipflops_high[0]
    )
    power_after_clock_gating.append(
        all_cells_normal_after[1]
        - clockgated_ff_cells_normal[1]
        + clockgated_ff_cells_low[1]
        - clock_gates_normal[1]
        + clock_gates_high[1]
        - not_gated_flipflops_normal[1]
        + not_gated_flipflops_high[1]
    )
    power_after_clock_gating.append(
        all_cells_normal_after[2]
        - clockgated_ff_cells_normal[2]
        + clockgated_ff_cells_low[2]
        - clock_gates_normal[2]
        + clock_gates_high[2]
        - not_gated_flipflops_normal[2]
        + not_gated_flipflops_high[2]
    )
    power_after_clock_gating.append(
        all_cells_normal_after[3]
        - clockgated_ff_cells_normal[3]
        + clockgated_ff_cells_low[3]
        - clock_gates_normal[3]
        + clock_gates_high[3]
        - not_gated_flipflops_normal[3]
        + not_gated_flipflops_high[3]
    )
    ####################################################################################################
    ...
    states.append(
        [
            ...
            str(
                (
                    (power_before_clock_gating[3] - power_after_clock_gating[3])
                    / power_before_clock_gating[3]
                )
                * 100
            )
            + " %",
    ...
    area_reduction = (
        -float(design_data.cell_diff) / float(design_data.cells_before_no) * 100
    )
    benchmarks.append(
        [
            design_data.design,
